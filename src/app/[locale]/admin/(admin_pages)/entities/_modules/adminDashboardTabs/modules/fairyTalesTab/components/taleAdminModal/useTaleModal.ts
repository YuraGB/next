...
import useUpdateTaleHandler from "@admin/(admin_pages)/entities/_modules/adminDashboardTabs/modules/fairyTalesTab/service/updateTaleHandler";
import { useAddNewTale } from "@admin/(admin_pages)/entities/_modules/adminDashboardTabs/modules/fairyTalesTab/service/useAddNewTale";
import { formatTaleData } from "@admin/(admin_pages)/entities/_modules/adminDashboardTabs/modules/fairyTalesTab/components/taleAdminModal/util/formatData";
